...
| Who | Start here |
| --- | --- |
| Café owner / manager | [Café owner quick card](./cafe-owner-quick-card.md) |
| Café owner, full | [SOP-02 Studio daily](./02-studio-daily.md) |
| You (agency) | [SOP-01 Launch a new café](./01-new-cafe-launch.md) |

## Owner pack (print / WhatsApp these)
...
| SOP | Use when |
| --- | --- |
| [00 How it works](./00-how-it-works.md) | Explain the product |
| [01 Launch a new café](./01-new-cafe-launch.md) | Duplicate the template for a client |
| [07 QR + tables](./07-qr-tables.md) | Print and place codes |
